...
us_url = 'https://locations.wendys.com/united-states/'
...
page_html = requests.get(us_url, headers = req_headers).text

page_soup = soup(page_html, 'html.parser')

states = page_soup.findAll('a', {'class': 'Directory-listLink'})

with open('data/wendys.csv', 'w', newline = '') as f:
...
for state in states:
    ...
    for city in cities:
        ...
        with open('data/wendys.csv', 'a', newline = '') as f:
